...
const insertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const titlefind = yield prisma_1.default.book.findFirst({
        where: {
            title: data.title,
        },
    });
...
const getbookFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const bookupdate = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    data.publicationDate = new Date(data.publicationDate);
...
const bookdelete = (id) => __awaiter(void 0, void 0, void 0, function* () {
